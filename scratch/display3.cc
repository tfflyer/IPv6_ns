...
//  NS_LOG_INFO ("Create nodes.");
  ...
  NodeContainer net12 (g, dst);

  NodeContainer routers (a, b, c, d);
  NodeContainer routers1(e,f,g);
...
//  NS_LOG_INFO ("Create channels.");
  ...
  CsmaHelper csma1;
  csma1.SetChannelAttribute ("DataRate", DataRateValue (10000000));
  csma1.SetChannelAttribute ("Delay", TimeValue (MilliSeconds (1.5)));
...
//  NS_LOG_INFO ("Create IPv6 and routing");
  ...
  ripNgRouting.ExcludeInterface (d, 4);
...
//    NS_LOG_INFO ("Create Applications.");
    ...
    ping6.SetRemote (iic12.GetAddress (1, 1));
